...
$\indent$ Los autores del paper original [@Barberia2018], los autores reportaron un t-test bayesiano ordinario con varianzas equivalentes entre grupos y reportaron un factor de Bayes. Aunque este método es computacionalmente menos eficiente, también podemos aproximarlo especificando el t-test en Stan y usando *bridge sampling*. La parametrización de este modelo está especificado en @Wetzels2009 con la diferencia de presentar las siguientes distribuciones a priori:
