...
$\indent$ Los efectos naturales directo (NDE) e indirecto (NIE) son identificados si (a) $X$ e $Y$ son independientes dado un set $C$ de covariables que incluye todas las variables confusoras, (b) $M$ e $Y$ son independientes dado X y C, (c) $X$ y $M$ son independientes dado C y (d) $M$ e $Y$ son independientes dado $C$ [@VanderWeele2016].
