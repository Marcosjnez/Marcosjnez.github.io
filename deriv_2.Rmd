...
$$
\begin{align}
\mu(x_1, x_2) \approx \mu(x_1^*, x_2^*) &+ \sum_{n=1}^\infty (x_1 - x_1^*)^n \, \left. \frac{\partial^n \mu}{\partial x_1^n} \right|_{x_1 = x_1^*} + \\
&+ \sum_{n=1}^\infty (x_2 - x_2^*)^n \, \left. \frac{\partial^n \mu}{\partial x_{2}^n} \right|_{x_2 = x_2^*} + \\
&+ \frac{1}{2} (x_1 - x_1^*) (x_2 - x_2^*) \left. \frac{\partial^2 \mu}{\partial x_1 x_2} \right|_{x_1x_2 = x_1^*x_2^*} + \\
&+ \frac{1}{2} (x_1 - x_1^*) (x_2 - x_2^*) \left. \frac{\partial^2 \mu}{\partial x_1^2 x_2} \right|_{x_1x_2 = x_1^*x_2^*} + \\
&+ \frac{1}{2} (x_1 - x_1^*) (x_2 - x_2^*) \left. \frac{\partial^2 \mu}{\partial x_1 x_2^2} \right|_{x_1x_2 = x_1^*x_2^*} + \\
&+ \frac{1}{2} (x_1 - x_1^*) (x_2 - x_2^*) \left. \frac{\partial^2 \mu}{\partial x_1^2 x_2^2} \right|_{x_1x_2 = x_1^*x_2^*}
\end{align}
$$
...
La tasa de cambio del valor ajustado $\widehat{m}(x_i)$ respecto a $y_i$ viene dado por

<br>

$$
\frac{\partial \widehat{m}(x_i)}{\partial y_i} = \mathbf{H}_{ii}
$$

<br>

Es decir, $\mathbf{H}_{ii}$ es la influencia de $y_i$ en su propio valor ajustado y nos dice cúanto de $\widehat{m}(x_i)$ es verdaderamente $y_i$ (las filas de $\mathbf{H}$ suman 1). Por tanto, a $\mathbf{H}_{ii}$ se le conoce como el **leverage** de $x_i$.
...
La función de regresión es propensa a ajustar los puntos de mayor *leverage*. Cuanto más cercano sea al valor 1, más se ajusta $\widehat{m}(x_i)$ a $y_i$.
