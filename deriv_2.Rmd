...
$$
AIC = L(\widehat\theta) - \text{número de parámetros estimados en el modelo}
$$
...
\Delta \ AIC &= L(\widehat\Theta) - L(\widehat\theta) - (p_{\Theta} - p_{\theta}) \\\\
...
$$
\begin{align}
\Delta \ AIC &\approx \frac{n}{2} \ \frac{\text{MSE}_{\ \widehat\theta} - \text{MSE}_{\ \widehat\Theta}}{\widehat\sigma^2} - (p_{\Theta} - p_{\theta}) \\\\
\frac{2 \widehat\sigma^2}{n} \Delta \ AIC &\approx \text{MSE}_{\ \widehat\theta} - \text{MSE}_{\ \widehat\Theta} + \frac{2 \widehat\sigma^2}{n} (p_{\Theta} - p_{\theta}) \\\\
\frac{2 \widehat\sigma^2}{n} \Delta \ AIC &\approx \Delta \ C_p
\end{align}
$$
