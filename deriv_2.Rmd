...
Por tanto, tras dividir por el número de contrastes $k$, la probabilidad de que un solo parámetro no se encuentre en su intervalo de confianza es igual o inferior a $\alpha$. Por esta razón, la correción de Bonferroni es conservadora.

Esta corrección tan solo exige que

$$
C(\alpha) = \prod_{i}^k C_i(\alpha / k)
$$
